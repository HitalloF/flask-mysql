...
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+pymysql://root:@localhost/youtube'
...
def seleciona_usuario(id):
    usuario_objetos = Usuario.query.filter_by(id=id).first()
    usuarios_json = usuario_objetos.to_json()
